...
## Входные данные
Прочитай файл `PRD-CleanFeedVK-2026-04-04.md` в текущей директории.
Также прочитай `PROJECT_STATUS.md` для понимания текущих блокеров и активных задач.
...
## После генерации tasks.json

1. Обнови `PROJECT_STATUS.md` — добавь ссылку на tasks.json как источник задач
2. Обнови `NEW_DIALOG_MESSAGE.md` — новый шаблон для старта сессии должен указывать на PRD и tasks.json
3. Первая задача для работы: выбери TASK с priority=critical и status=pending, опиши её в PROJECT_STATUS.md как "текущий трек"